...
public class SampleAsyncWait implements MqttCallback {
    ...
    String url = protocol + broker + ":" + port;
		...
		try {
			...
			if (action.equals("publish")) {
				...
				// DK: If quiet mode, read the message to send from standard input
				if (quietMode) {
   ...
   * @param userName the username to connect with
	...
	public void messageArrived(String topic, MqttMessage message) throws MqttException {
		...
		// DK: check if it's a beacon and respond
		...
		if (msg.startsWith("BEACON")) {
			...
			try {
				...
				System.out.println("Executing '" + cmd + "' done");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
